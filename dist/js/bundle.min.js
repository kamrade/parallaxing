...
module.exports = function(output){
  ...
  $('.sub-title').text('jQuery is here too 01');
};

},{"../../libs/jquery/dist/jquery.min":4}],3:[function(require,module,exports){
var $ = require('../libs/jquery/dist/jquery.min');

module.exports = function(){
  console.log('Hello 14');
  $('.title').text('jQuery again');
};

},{"../libs/jquery/dist/jquery.min":4}],4:[function(require,module,exports){
